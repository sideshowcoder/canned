...
Response.prototype.send = function (force) {
  if (this.response_delay !== 0 && !force) {
    return this.delay();
  }
...
Response.prototype.delay = function () {
  setTimeout(this.send.bind(this, true), this.response_delay);
}
